...
${City}                         New York
${ZipCode}                      03101
${Sale Name}                    NEW YEAR'S SALE
${Sale Name Now}                NEW YEAR'S SALE NOW
${Sale Details}                 $300 OFF + FREE PILLOW
${Sale Details 350}             $350 OFF + FREE PILLOW
${Discount Amount}              $300 OFF
${Discount Amount 350}          $350 OFF
${Timer}                        NEW YEAR'S SALE NOW $300 OFF + FREE PILLOW
...
${12ReasonsPDP}                 css=#productReasons > div.block__rich_text_and_image.block__product-pad-template-0 > div > div > div > h2
${CartDrawerTitle}              Your Puffy Cart
${CartDrawerNote}               CHECKOUT
...
${PuffyLuxMattressH2}           12 REASONS TO CHOOSE PUFFY LUX MATTRESS
${PuffyLuxHybridMattressH1}     Puffy Lux Hybrid Mattress
${PuffyLuxHybridMattressH2}     12 REASONS TO CHOOSE PUFFY LUX Hybrid MATTRESS
...
${PuffyRoyalMattressH2}         12 REASONS TO CHOOSE PUFFY ROYAL MATTRESS
${PuffyRoyalHybridMattressH1}   Puffy Royal Hybrid Mattress
${PuffyRoyalHybridMattressH2}   12 REASONS TO CHOOSE PUFFY ROYAL Hybrid MATTRESS
...
${Paypalh1}                     Pay with PayPal
${SplititH1}                    How Splitit Works
${KlarnaH1}                     Place Order

${COMPAREPAGEH1}                CHOOSE YOUR PUFFY MATTRESS
...
Check Seasonal Sale text on timer
    ...
    Run keyword if          "${Content}"!="${Timer350}"                Fail        Wrong Seasonal Sale text on timer Expected: ${Timer350} Actual: ${Content}
...
Check discount value and freebie on Homepage
    ...
    Run keyword if          "${Content}"!="${Sale Details 350}"         Fail        Wrong discount value and freebie text on homepage Expected: ${Sale Details 350} Actual: ${Content}

Check discount value and freebie on Mattress PDPs
    ${Content}=            get text        css=#_300_Off_FREE_PILLOW
    Run keyword if          "${Content}"!="${Sale Details 350}"         Fail        Wrong discount value and freebie text on mattress PDP Expected: ${Sale Details 350} Actual: ${Content}
...
Check Seasonal Sale text on badges
    ...
    Run keyword if          "${Content}"!="${Sale Name Now}"            Fail        Wrong Seasonal Sale text on badges Expected: ${Sale Name Now} Actual: ${Content}

Check discount value and freebie on badges for mattresses
    sleep                   2s
    ${Content}=            get text        css=#_300_OFF_FREE_PILLOW
    Run keyword if          "${Content}"!="${Sale Details 350}"         Fail        Wrong discount value and freebie text on badges for mattress Expected: ${Sale Details 350} Actual: ${Content}
...
Check discount value on badges for adjustable base
    ...
    Run keyword if          '${Content}'!='${Discount Amount 350}'      Fail        Wrong discount value text on badge for adjustable base Expected: ${Discount Amount 350} Actual: ${Content}

Check discount value on Adjustable Base PDP
    sleep                   2s
    ${Content}=            get text        css=#_300_Off
    Run keyword if          '${Content}'!='${Discount Amount 350}'      Fail        Wrong discount value on adjustable base PDP Expected: ${Discount Amount 350} Actual: ${Content}
...
Go to Puffy Lux Mattress Product Page
    ...
    ${Content}=            get text         css=#productReasons > div.block__rich_text_and_image.block__product-pad-template-0 > div > div > div > h2
    Run keyword if         '${Content}'!='${PuffyLuxMattressH2}'               Fail        Product Name (H1) not found Expected: ${PuffyLuxMattressH2} Actual: ${Content}
...
Click on Puffy Lux Hybrid Toggle
    ...
    ${Content}=            get text         ${12ReasonsPDP}
    Run keyword if         '${Content}'!='${PuffyLuxHybridMattressH2}'               Fail        Product Name (H1) not found Expected: ${PuffyLuxHybridMattressH2} Actual: ${Content}
#enhancement
...
Go to Puffy Royal Mattress Product Page
    ...
    ${Content}=            get text         ${12ReasonsPDP}
    Run keyword if         '${Content}'!='${PuffyRoyalMattressH2}'               Fail        Product Name (H1) not found Expected: ${PuffyRoyalMattressH2} Actual: ${Content}
#enhancement
...
Click on Puffy Royal Hybrid Toggle
    ...
    ${Content}=            get text         ${12ReasonsPDP}
    Run keyword if         '${Content}'!='${PuffyRoyalHybridMattressH2}'               Fail        Product Name (H1) not found Expected: ${PuffyRoyalHybridMattressH2} Actual: ${Content}
#enhancement
...
Check Puffy Mattress Discounted prices (all sizes)
    ...
    Run keyword if          '${Content}'!='${PuffyMattTwin350OFF}'          Fail        Wrong Discounted price for Puffy Mattress Twin Expected: ${PuffyMattTwin350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyMattTwinXL350OFF}'        Fail        Wrong Discounted price for Puffy Mattress Twin XL Expected: ${PuffyMattTwinXL350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyMattFull350OFF}'          Fail        Wrong Discounted price for Puffy Mattress Full Expected: ${PuffyMattFull350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyMattQueen350OFF}'         Fail        Wrong Discounted price for Puffy Mattress Queen Expected: ${PuffyMattQueen350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyMattKing350OFF}'          Fail        Wrong Discounted price for Puffy Mattress King Expected: ${PuffyMattKing350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyMattCalKing350OFF}'       Fail        Wrong Discounted price for Puffy Mattress Cal King Expected: ${PuffyMattCalKing350OFF} Actual: ${Content}
...
Check Puffy Lux Discounted prices (all sizes)
    ...
    Run keyword if          '${Content}'!='${PuffyLuxTwin350OFF}'           Fail        Wrong Discounted price for Puffy Lux Mattress Twin Expected: ${PuffyLuxTwin350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxTwinXL350OFF}'         Fail        Wrong Discounted price for Puffy Lux Mattress Twin XL Expected: ${PuffyLuxTwinXL350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxFull350OFF}'           Fail        Wrong Discounted price for Puffy Lux Mattress Full Expected: ${PuffyLuxFull350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxQueen350OFF}'          Fail        Wrong Discounted price for Puffy Lux Mattress Queen Expected: ${PuffyLuxQueen350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxKing350OFF}'           Fail        Wrong Discounted price for Puffy Lux Mattress King Expected: ${PuffyLuxKing350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxCalKing350OFF}'        Fail        Wrong Discounted price for Puffy Lux Mattress Cal King Expected: ${PuffyLuxCalKing350OFF} Actual: ${Content}
...
Check Puffy Lux Hybrid Discounted prices (all sizes)
    ...
    Run keyword if          '${Content}'!='${PuffyLuxTwin350OFF}'           Fail        Wrong Discounted price for Puffy Lux Hybrid Mattrress Twin Expected: ${PuffyLuxTwin350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxTwinXL350OFF}'         Fail        Wrong Discounted price for Puffy Lux Hybrid Mattrress Twin XL Expected: ${PuffyLuxTwinXL350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxFull350OFF}'           Fail        Wrong Discounted price for Puffy Lux Hybrid Mattrress Full Expected: ${PuffyLuxFull350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxQueen350OFF}'          Fail        Wrong Discounted price for Puffy Lux Hybrid Mattrress Queen Expected: ${PuffyLuxQueen350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxKing350OFF}'           Fail        Wrong Discounted price for Puffy Lux Hybrid Mattrress King Expected: ${PuffyLuxKing350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyLuxCalKing350OFF}'        Fail        Wrong Discounted price for Puffy Lux Hybrid Mattrress Cal King Expected: ${PuffyLuxCalKing350OFF} Actual: ${Content}
...
Check Puffy Royal Discounted prices (all sizes)
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalTwin350OFF}'         Fail        Wrong Discounted price for Puffy Royal Mattress Twin Expected: ${PuffyRoyalTwin350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalTwinXL350OFF}'       Fail        Wrong Discounted price for Puffy Royal Mattress Twin XL Expected: ${PuffyRoyalTwinXL350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalFull350OFF}'         Fail        Wrong Discounted price for Puffy Royal Mattress Full Expected: ${PuffyRoyalFull350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalQueen350OFF}'        Fail        Wrong Discounted price for Puffy Royal Mattress Queen Expected: ${PuffyRoyalQueen350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalKing350OFF}'         Fail        Wrong Discounted price for Puffy Royal Mattress King Expected: ${PuffyRoyalKing350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalCalKing350OFF}'      Fail        Wrong Discounted price for Puffy Royal Mattress Cal King Expected: ${PuffyRoyalCalKing350OFF} Actual: ${Content}
...
Check Puffy Royal Hybrid Discounted prices (all sizes)
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalTwin350OFF}'         Fail        Wrong Discounted price for Puffy Royal Hybrid Mattress Twin Expected: ${PuffyRoyalTwin350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalTwinXL350OFF}'       Fail        Wrong Discounted price for Puffy Royal Hybrid Mattress Twin XL Expected: ${PuffyRoyalTwinXL350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalFull350OFF}'         Fail        Wrong Discounted price for Puffy Royal Hybrid Mattress Full Expected: ${PuffyRoyalFull350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalQueen350OFF}'        Fail        Wrong Discounted price for Puffy Royal Hybrid Mattress Queen Expected: ${PuffyRoyalQueen350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalKing350OFF}'         Fail        Wrong Discounted price for Puffy Royal Hybrid Mattress King Expected: ${PuffyRoyalKing350OFF} Actual: ${Content}
    ...
    Run keyword if          '${Content}'!='${PuffyRoyalCalKing350OFF}'      Fail        Wrong Discounted price for Puffy Royal Hybrid Mattress Cal King Expected: ${PuffyRoyalCalKing350OFF} Actual: ${Content}
...
Select and proceed with Paypal
    ...
    Run keyword if          '${Content}'!='${Paypalh1}'     Fail        Paypal (H1) not found Expected: ${Paypalh1} Actual: ${Content}
    sleep                               2s
...
Select and proceed with Splitit
    ...
    Run keyword if          '${Content}'!='${SplititH1}'     Fail        Checkout - Information tab (H1) not found Expected: ${SplititH1} Actual: ${Content}
    sleep                               2s
    Go Back
    sleep                               2s
    wait until page contains            All transactions are secure and encrypted.
...
Select and proceed with Klarna
    ...
    sleep                               5s
    wait until page contains element     css=#placeOrderButton
    ${Content}=            get text     css=#placeOrderButton
    Run keyword if          '${Content}'!='${KlarnaH1}'     Fail        Checkout - Information tab (H1) not found Expected: ${KlarnaH1} Actual: ${Content}
    sleep                               2s
...
Verify H1 on Comparison Page
    sleep                               5s
    #Wait until page contains            ${COMPAREPAGEH1}
    ${Content}=            get text     css=body > div.container.main.content > div > div.compare-page__headline > h1
    Run keyword if          '${Content}'!='${COMPAREPAGEH1}'     Fail        Checkout - Information tab (H1) not found Expected: ${COMPAREPAGEH1} Actual: ${Content}
...
Verify H1 on Puffy PDP
    Wait until page Contains            ${PuffyMattressH1}
    ${Content}=            get text     css=#shopify-section-product-puffy-template > div.container.main.content.product-name--puffy-mattress > div > div > div > div > div.seven.columns.medium-down--one-whole.alpha > div > div.product-head > div.product-head__headline > h1
    Run keyword if          '${Content}'!='${PuffyMattressH1}'     Fail        Checkout - Information tab (H1) not found Expected: ${PuffyMattressH1} Actual: ${Content}
