...
Check the details in first section of Puffy Guarantee page
    ...
    Check if page banner title is showing with correct content
    Check if page banner description is showing with correct content
Check the Details in Get Puffy 100% Risk free block
    Check if the block is showing the title with correct content
    Check if the block is showing the description with correct content
    Check if the 3 upsell images are showing
    Check if the 3 upsell texts are showing with correct content
Check the details in Puffy Lifetime warranty block
    Check if the block is showing the title with correct content
    Check if the block featured text is showing with correct content
