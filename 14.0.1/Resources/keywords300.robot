...
Check Puffy Dog Bed original prices
    ...
    Run keyword if          '${Content}'!='${PUFFYDOGBEDSMALLORIGINAL50}'      Fail        Wrong Puffy Dog Bed Small Size original price. Expected Result: ${PUFFYDOGBEDSMALLORIGINAL50} Actual Result: ${Content}
...
Select Puffy Pillow Standard
    Click element           css=#product_form_625398710306 > div.product-variants-holder > div.product-variant.selector-wrapper.jsRealOptions.product-size > div > ul > li:nth-child(1)
...
Check price in Store page for Puffy Dog Bed
    ...
    Run keyword if          '${PUFFYDOGBEDSMALLORIGINAL50}'!='${PuffyDogBedMinDiscountedStorePage}'      Fail        Wrong Puffy Dog Bed "Starting From" Discounted amount in Store Page. Expected Result: ${PUFFYDOGBEDSMALLORIGINAL50} Actual Result: ${PuffyDogBedMinDiscountedStorePage}
...
Check price in GiftShop page for Puffy Pillow
    scroll element into view                                        css=body > div:nth-child(18) > div > div > div:nth-child(1) > div > a > div.product-box__content > div.product-box__desc > div.product-box__prices > strong
    sleep                                   2s
    wait until page contains element                        css=body > div:nth-child(18) > div > div > div:nth-child(1) > div > a > div.product-box__content > div.product-box__desc > div.product-box__prices > strong
    ${PuffyPillowMinOriginalStorePage}=     get text        css=body > div:nth-child(18) > div > div > div:nth-child(1) > div > a > div.product-box__content > div.product-box__desc > div.product-box__prices > strong
