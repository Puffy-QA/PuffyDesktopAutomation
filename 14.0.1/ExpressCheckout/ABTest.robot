...
${Homepage}                     https://puffy.com/?preview_theme_id=83899940898&pretest_ab=true
...
Homepage Seasonal Sale text check
    ...
    Run keyword if          '${Content}'!='${Sale Name}'      Fail        Wrong Seasonal Sale Content Expected: ${Sale Name} Actual: ${Content}
...
Select Splitit
    ...
    click element                       xpath=//*[@id="continue_button"]
    sleep                               5s
    wait until page contains            Please select the number of payments
    sleep                               2s
