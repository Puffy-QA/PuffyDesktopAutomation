...
${FOOTER}                       WINTER SALE NOW $300 OFF + FREE PILLOW
...
${PuffyMattressTwinSplitIt300Offby12}                   $41.25
${PuffyMattressTwinXLSplitIt300Offby12}                 $43.75
${PuffyMattressFullSplitIt300Offby12}                   $57.92
${PuffyMattressQueenSplitIt300Offby12}                  $70.83
${PuffyMattressKingSplitIt300Offby12}                   $87.50
${PuffyMattressCalKingSplitIt300Offby12}                $87.50
...
${PuffyLuxMattressTwinSplitIt300Offby12}                $95.42
${PuffyLuxMattressTwinXLSplitIt300Offby12}              $99.58
${PuffyLuxMattressFullSplitIt300Offby12}                $107.92
${PuffyLuxMattressQueenSplitIt300Offby12}               $124.58
${PuffyLuxMattressKingSplitIt300Offby12}                $141.25
${PuffyLuxMattressCalKingSplitIt300Offby12}             $141.25
...
${PuffyRoyalMattressTwinSplitIt300Offby12}                $112.08
${PuffyRoyalMattressTwinXLSplitIt300Offby12}              $120.42
${PuffyRoyalMattressFullSplitIt300Offby12}                $178.75
${PuffyRoyalMattressQueenSplitIt300Offby12}               $199.58
${PuffyRoyalMattressKingSplitIt300Offby12}                $224.58
${PuffyRoyalMattressCalKingSplitIt300Offby12}             $224.58
...
${PuffyAdjustableBaseTwinXLSplitIt300Offby12}           $74.58
${PuffyAdjustableBaseFullSplitIt300Offby12}             $82.92
${PuffyAdjustableBaseQueenSplitIt300Offby12}            $91.25
${PuffyAdjustableBaseSplitKingSplitIt300Offby12}        $149.58
...
Banner Seasonal Sale text check
    ...
    Run keyword if          '${Content}'!='${Sale Name}'      Fail        Wrong Seasonal Sale Content Actual Result: ${Content} Expected: ${FOOTER}
...
Check Puffy Mattress Pad PDP Default size
    ${DefaultSize}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > div > div > span.display-name.is--sale--price
...
Check Puffy Mattress Pad original prices
    ...
    Wait Until Element Is Visible          css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(1) > span > del > span.original-price
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(1) > span > del > span.original-price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(2) > span > del > span.original-price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(3) > span > del > span.original-price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(4) > span > del > span.original-price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(5) > span > del > span.original-price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(6) > span > del > span.original-price
...
Check Puffy Mattress Pad sizes list order
    ...
    Wait Until Element Is Visible          css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(1) > div > span.display-name.is--sale--price

    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(1) > div > span.display-name.is--sale--price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(2) > div > span.display-name.is--sale--price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(3) > div > span.display-name.is--sale--price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(4) > div > span.display-name.is--sale--price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(5) > div > span.display-name.is--sale--price
    ...
    ${Content}=            get text        css=#product_form_4830838194210 > div.product-variants-holder > div > div > ul > li:nth-child(6) > div > span.display-name.is--sale--price
...
Check Puffy Royal Mattress Twin size monthly payment price
    ...
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressTwinSplitIt300Offby12}'      Fail      Wrong Puffy Lux Mattress Twin Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressTwinSplitIt300Offby12} Actual Result: ${Splitit}
...
Check Puffy Foundation Full size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_150983180312 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyFoundationFullSplitIt15%Offby12}'      Fail      Wrong Foundation Full Size monthly payment for Splitit. Expected Result: ${PuffyFoundationFullSplitItNoOffby12} Actual Result: ${Splitit}
...
Check Puffy Comforter Twin/Twin XL size monthly payment price
    ...
    Run keyword if          '${Splitit}'!='${PuffyComforterTwin/TwinXLSplitIt15Offby12}'      Fail      Wrong Puffy Comforter Twin/Twin XL Size monthly payment for Splitit. Expected Result: ${PuffyBedFrameFullSplitIt300Offby12} Actual Result: ${Splitit}
...
Check Puffy Comforter Full/Queen size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_1536090603554 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyComforterFull/QueenSplitIt15Offby12}'      Fail      Wrong Puffy Comforter Full/Queen Size monthly payment for Splitit. Expected Result: ${PuffyBedFrameQueenSplitIt300Offby12} Actual Result: ${Splitit}
...
Check Puffy Rug Medium size monthly payment price
    ...
    Run keyword if          '${Splitit}'!='${PuffyRugMediumSplitIt15Offby12}'      Fail      Wrong Puffy Rug Medium size monthly payment for Splitit. Expected Result: ${PuffyRugMediumSplitItNoOffby12} Actual Result: ${Splitit}
Check Puffy Rug Large size monthly payment price
    sleep                               2s
    ${Klarna}=            get text        css=#product_form_4125949657122 > div.hc-custom-block.finance-area > div:nth-child(1) > klarna-placement > a:nth-child(2) > klarna-placement-style-amount
    ...
    ${Splitit}=            get text        css=#product_form_4125949657122 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyRugLargeSplitIt15Offby12}'      Fail      Wrong Puffy Rug Large size monthly payment for Splitit. Expected Result: ${PuffyRugLargeSplitItNoOffby12} Actual Result: ${Splitit}
...
Price check for Puffy Lux Mattress
    ...
    Run keyword if          '${PuffyLuxTwin300OFF}'!='${PuffyLuxMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyLuxTwin300OFF} Actual Result: ${PuffyLuxMinDiscountedStorePage}
Price check for Puffy Royal Mattress
    ...
    Run keyword if          '${PuffyRoyalTwin300OFF}'!='${PuffyRoyalMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyRoyalTwin300OFF} Actual Result: ${PuffyRoyalMinDiscountedStorePage}
Price check for Puffy Adjustable Base
    ...
    Run keyword if          '${PuffyAdjustTwinXL300OFF}'!='${PuffyAdjustableBaseMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyAdjustTwinXL300OFF} Actual Result: ${PuffyAdjustableBaseMinDiscountedStorePage}

Price check for Puffy Bed Frame
    ${PuffyBedFrameMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(5) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyBedFrameMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(5) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyBedFrameFull15%OFF}'!='${PuffyBedFrameMinDiscountedStorePage}'      Fail        Wrong Puffy Bed Frame "Starting From" discounted amount in Store Page. Expected Result: ${PuffyBedFrameFull15%OFF} Actual Result: ${PuffyBedFrameMinDiscountedStorePage}
Price check for Puffy Foundation
    ${PuffyFoundationMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(6) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyFoundationMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(6) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyFoundationTwin15%OFF}'!='${PuffyFoundationMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyFoundationTwin15%OFF} Actual Result: ${PuffyFoundationMinDiscountedStorePage}
Price check for Puffy Pillow
...
Price check for Puffy Body Pillow
    ...
    ${PuffyBodyPillowMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(8) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyBodyPillow15%OFF}'!='${PuffyBodyPillowMinDiscountedStorePage}'      Fail        Wrong Puffy Body Pillow "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyBodyPillow15%OFF} Actual Result: ${PuffyBodyPillowMinDiscountedStorePage}
Price check for Puffy Mattress Protector
    ${PuffyMattressProtectorMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(9) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    Run keyword if          '${PuffyProtectorQueenOriginal}'!='${PuffyMattressProtectorMinOriginalStorePage}'      Fail        Wrong Puffy Mattress Protector "Starting From" Original amount in Store Page. Expected Result: ${PuffyProtectorQueenOriginal} Actual Result: ${PuffyMattressProtectorMinOriginalStorePage}
    ${PuffyMattressProtectorMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(9) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyProtectorQueen15%OFF}'!='${PuffyMattressProtectorMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress Protector "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyProtectorQueen15%OFF} Actual Result: ${PuffyMattressProtectorMinDiscountedStorePage}
Price check for Puffy Comforter
    ${PuffyComforterMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(10) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyComforterMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(10) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyComforterTwin/TwinXL15%OFF}'!='${PuffyComforterMinDiscountedStorePage}'      Fail        Wrong Puffy Comforter "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyComforterTwin/TwinXL15%OFF} Actual Result: ${PuffyComforterMinDiscountedStorePage}
Price check for Puffy Mattress Pad
    ${PuffyMattressPadMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(11) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyMattressPadMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(11) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyPadTwin15%OFF}'!='${PuffyMattressPadMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress Pad "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyPadTwin15%OFF} Actual Result: ${PuffyMattressPadMinDiscountedStorePage}
Price check for Puffy Topper
    ${PuffyTopperMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(12) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyTopperMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(12) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyTopperTwin15%OFF}'!='${PuffyTopperMinDiscountedStorePage}'      Fail        Wrong Puffy Body Pillow "Starting From" Original amount in Store Page. Expected Result: ${PuffyTopperTwin15%OFF} Actual Result: ${PuffyTopperMinDiscountedStorePage}
Price check for Puffy Blanket
...
Price check for Puffy Weighted Blanket
    ${PuffyWeightedBlanketMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(14) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyWeightedBlanketMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(14) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyWeightedBlanketTwin15%OFF}'!='${PuffyWeightedBlanketMinDiscountedStorePage}'      Fail        Wrong Puffy Weighted Blanket "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyWeightedBlanketTwin15%OFF} Actual Result: ${PuffyWeightedBlanketMinDiscountedStorePage}
Price check for Puffy Sheets
    ${PuffySheetsMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(15) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    Run keyword if          '${PuffySheetsTwinXLOriginal}'!='${PuffySheetsMinOriginalStorePage}'      Fail        Wrong Puffy Sheets "Starting From" Original amount in Store Page. Expected Result: ${PuffySheetsTwinOriginal} Actual Result: ${PuffySheetsMinOriginalStorePage}
    ${PuffySheetsMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(15) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffySheetsTwinXL15%OFF}'!='${PuffySheetsMinDiscountedStorePage}'      Fail        Wrong Puffy Sheets "Starting From" Discounted amount in Store Page. Expected Result: ${PuffySheetsTwinXL15%OFF} Actual Result: ${PuffySheetsMinDiscountedStorePage}
Price check for Puffy Dog Bed
    ...
    Run keyword if          '${PuffyDogBedSmall15%Off}'!='${PuffyDogBedMinDiscountedStorePage}'      Fail        Wrong Puffy Dog Bed "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyDogBedSmall15%Off} Actual Result: ${PuffyDogBedMinDiscountedStorePage}

Price check for Puffy Rug
    ${PuffyRugMinOriginalStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(17) > div > div.product-details > a.product-info__caption > span.price.sale > span.was_price > span
    ...
    ${PuffyRugMinDiscountedStorePage}=     get text        css=#collectionProductsWrap > div:nth-child(17) > div > div.product-details > a.product-info__caption > span.price.sale > span.money
    Run keyword if          '${PuffyRugMedium15%Off}'!='${PuffyRugMinDiscountedStorePage}'      Fail        Wrong Puffy Rug "Starting From" Discounted amount in Store Page. Expected Result: ${PuffyRugMedium15%Off} Actual Result: ${PuffyRugMinDiscountedStorePage}
