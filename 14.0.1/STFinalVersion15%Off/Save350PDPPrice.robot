...
Check Puffy Royal Mattress Twin size monthly payment price
    ...
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressTwinSplitIt350Offby12}'      Fail      Wrong Puffy Royal Mattress Twin Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressTwinSplitIt350Offby12} Actual Result: ${Splitit}
...
Check Puffy Royal Mattress TwinXL size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_3832788910114 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressTwinXLSplitIt350Offby12}'      Fail      Wrong Puffy Royal Mattress Twin XL Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressTwinXLSplitIt350Offby12} Actual Result: ${Splitit}
...
Check Puffy Royal Mattress Full size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_3832788910114 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressFullSplitIt350Offby12}'      Fail      Wrong Puffy Royal Mattress Full Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressFullSplitIt350Offby12} Actual Result: ${Splitit}
...
Check Puffy Royal Mattress Queen size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_3832788910114 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressQueenSplitIt350Offby12}'      Fail      Wrong Puffy Royal Mattress Queen Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressQueenSplitIt350Offby12} Actual Result: ${Splitit}
...
Check Puffy Royal Mattress King size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_3832788910114 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressKingSplitIt350Offby12}'      Fail      Wrong Puffy Royal Mattress King Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressKingSplitIt350Offby12} Actual Result: ${Splitit}
...
Check Puffy Royal Mattress Cal King size monthly payment price
    ...
    ${Splitit}=            get text        css=#product_form_3832788910114 > div.hc-custom-block.finance-area > div.finance-area__box.finance-area__box--separator > div > a.data-splitit-logo > span.data-splitit-price > span
    Run keyword if          '${Splitit}'!='${PuffyRoyalMattressCalKingSplitIt350Offby12}'      Fail      Wrong Puffy Royal Mattress Cal King Size monthly payment for Splitit. Expected Result: ${PuffyRoyalMattressCalKingSplitIt350Offby12} Actual Result: ${Splitit}
...
Price check for Puffy Mattress
    ...
    Run keyword if          '${PuffyMattTwin350OFF}'!='${PuffyMattressMinDiscountedStorePage}'      Fail        Wrong Puffy Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyMattTwin350OFF} Actual Result: ${PuffyMattressMinDiscountedStorePage}
...
Price check for Puffy Lux Mattress
    ...
    Run keyword if          '${PuffyLuxTwin350OFF}'!='${PuffyLuxMinDiscountedStorePage}'      Fail        Wrong Puffy Lux Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyLuxTwin350OFF} Actual Result: ${PuffyLuxMinDiscountedStorePage}
Price check for Puffy Royal Mattress
    ...
    Run keyword if          '${PuffyRoyalTwin350OFF}'!='${PuffyRoyalMinDiscountedStorePage}'      Fail        Wrong Puffy Royal Mattress "Starting From" discounted amount in Store Page. Expected Result: ${PuffyRoyalTwin350OFF} Actual Result: ${PuffyRoyalMinDiscountedStorePage}
Price check for Puffy Adjustable Base
    ...
    Run keyword if          '${PuffyAdjustTwinXL350OFF}'!='${PuffyAdjustableBaseMinDiscountedStorePage}'      Fail        Wrong Puffy Adjustable Base "Starting From" discounted amount in Store Page. Expected Result: ${PuffyAdjustTwinXL350OFF} Actual Result: ${PuffyAdjustableBaseMinDiscountedStorePage}
...
Price check for Puffy Foundation
    ...
    Run keyword if          '${PuffyFoundationTwin15%OFF}'!='${PuffyFoundationMinDiscountedStorePage}'      Fail        Wrong Puffy Foundation "Starting From" discounted amount in Store Page. Expected Result: ${PuffyFoundationTwin15%OFF} Actual Result: ${PuffyFoundationMinDiscountedStorePage}
Price check for Puffy Pillow
...
Check amount in Pay as low as for Klarna
    ...
    Run keyword if          '${$350PuffyFinancingPageKlarna}'!='${KlarnaPayAsLow}'      Fail        Wrong Amount for Klarna "Pay as low as" section. Expected Result: ${$300PuffyFinancingPageKlarna} Actual Result: ${KlarnaPayAsLow}
...
Check amount in Pay as low as for SplitIt
    ...
    Run keyword if          '${$350PuffyFinancingPageSplitIt}'!='${SplitItPayAsLow}'      Fail      Wrong Amount for SplitIt "Pay as low as" section. Expected Result: ${$300PuffyFinancingPageSplitIt} Actual Result: ${SplitItPayAsLow}
Click Splitit See Details link
